...
public class OrientatUA2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    if (activities.size() == 0)
	    {
	    	...
	    	Toast.makeText(getApplicationContext(), "Servicio de micr贸fono desactivado", Toast.LENGTH_LONG).show();
	    	manager.speak("Micr贸fono desactivado");			
	    }		
	    /*else
	...
	public void getCurrentLocation() {		
		if(gps.canGetLocation()) {
			...
			if(current!=null) {
				...
				//Toast.makeText(getApplicationContext(), "No se ha podido obtener la ubicaci贸n", Toast.LENGTH_LONG).show();
				manager.speak("No se ha podido obtener la ubicaci贸n");	
			}						
		}
		else
			gps.setSettings();
	...
	public void getRoute() {	
		...
		Address address=gps.getCoordinates("Plaza Santa Faz 03690 San Vicente del Raspeig Alicante Espa馻");
		Address address2=gps.getCoordinates("Calle San Pablo 13 03690 San Vicente del Raspeig Alicante Espa馻");
		
		//String error=directions.makeRequest("Calle San Pablo 13 03690 San Vicente del Raspeig Alicante Espa馻", "Plaza Santa Faz 03690 San Vicente del Raspeig Alicante Espa馻");
		...
		Address address=gps.getCoordinates("Plaza Santa Faz 03690 San Vicente del Raspeig Alicante Espa帽a");
		...
		if(address!=null) {
			...
			String error=directions.makeRequest("Calle San Pablo 13 03690 San Vicente del Raspeig Alicante Espa帽a", address.toString());
			distance.add(error);
